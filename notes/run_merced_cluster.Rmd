...
## If you are outside the UC Merced network, turn your VPN on!
...
There is one available in /home/help/sample.sub
...
```
scp local/file/address USERNAME@merced.ucmerced.edu:/destinationfolder/
```
