...
Estimates range between 3 000 000 and 100 000 000 living species

---
background-image: url("bg/tree-of-life.png")
background-position: center
background-size: contain
...
.row[.content[
### A graphical representation of a hypothesis of ancestor-descendant relationships among living and extinct species
]]
.row[.content[
...
# Use of phylogenies in science


Images of modern phylogenies

Conclusion: phylogenies are very important

---
# Because they are important, there are a lot of phylogenies

Graphs of accumulation of phylogenies through time

---

# Hoy do you produce them?


Conclusion: They are hard to make and it is a very artisanal endeavor.

---

# How do you get them?

Main: Reuse of phylogenies is important
...
<img align="right" width="350" src="bg/treebase-wget-2.gif">

.column[.content[
```
wget "http://purl.org/phylo/treebase/phylows/matrix/TB2:M4382?format=nexus"
```
]]
