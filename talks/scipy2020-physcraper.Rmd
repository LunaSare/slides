...
# How do we .blue[generate] a phylogeny?
]]
.row.split-five[
...
---
background-image: url("bg/1-gray2.png")
background-position: center
background-size: contain
...
this .blue[massive] amount of raw .red[data]?]


---
background-image: url("bg/1-blue-cerulean.png")
background-position: center
background-size: contain
...
---
background-image: url("bg/1-blue-cerulean2.png")
background-position: center
background-size: contain
...
.row[.content.vmiddle[
# &emsp; Getting the published tree .gray[in computer readable format]
...
.row.split-60[
.column[.content.vmiddle[
### &emsp; &emsp; &emsp; &#183; TreeBASE - Released .indigo[1994]
...
.column[.content[
<img align="center" width="100%" src="bg/20-treebase-wget-2.gif">
]]
---
class: split-two
